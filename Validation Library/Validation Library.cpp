...

{
    ...
    int y = clsInputValidate::ReadNumberBetween(1, 5, "Number is not within range, enter again:\n");
    cout << "y=" << y;
    ...
    double b = clsInputValidate::ReadNumberBetween(1, 5, "Number is not within range, enter again:\n");
    cout << "b=" << b;
